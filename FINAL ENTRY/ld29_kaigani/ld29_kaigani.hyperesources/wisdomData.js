...
"Yi Ching I Ching",
"The two main English translations are:",
"The Classic of Changes: A New Translation of the I Ching as Interpreted by Wang Bi, translated by Richard John ",
"Lynn, (New York: Columbia University Press, 1994).  A much more uptodate translation than the famous ",
"Wilhelm version. See review in The New Republic 11/16/1994.",
"I Ching [Book of Changes], trans [into German], Richard Wilhelm, rendered into English by Cary F. Barnes, 3rd. ed., ",
"Bollingen Series XIX, (Princeton NJ: Princeton University Press, 1967, 1st ed. 1950) For decades the ",
"standard English version of the I Ching.  ",
"This present document - the core text [sometiimes called the Zhou Yi, without the 7 [or ten] wings] is available on ",
"the internet, via the World Wide Web, at http://www.monash.edu.au/cc/staff/sas/sab/WWW/changes.txt",
"",
"The hexagrams were obtained from an I Ching program named ching, it is available via anonymous ftp from ",
"vixen.cso.uiuc.edu in the games/ching directory.",
"Last modified: September 16, 1994",
"",
"These directions are extremely terse.  I am a novice and would require much more experience before I would feel ",
"qualified totry to explain any more than I have.",
"To generate the hexagram, you will need three coins.  Old Chinese bronze coins are not necessary, but are a nice ",
"touch.  The head side (or the blank side) of the coin is yang, while the tail side (or enscripted side) is yin.  The coins ",
"are tossed, and by assigning values to yin (2 points) and yang (three points), each of the six lines in the hexagram are ",
"generated.",
"The original method uses yarrow stalks, and while many say this gives better readings, I have not used it and wouldn't ",
...
"7. If there are moving lines, draw a second hexagram by aging the old lines, i.e. an old Yin line (6) becomes a Yang ",
"line, and an old Yang line (9) becomes a Yin line.  Read this hexagram.",
"------",
...
"          As a hair clasp gathers the hair.        Six at the top means:",
"          Deluded enthusiasm.",
...
"          -- --",
"     The Judgement",
"          Development.         Thus the superior man abides in dignity and virtue,",
