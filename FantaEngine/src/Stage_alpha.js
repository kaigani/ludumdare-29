...
// -----------------------
	...
	this.loadAnimation = function(name,graph,timeline){
	...
	this.loadAnimationByUrl = function(loader,url){
		loader.loadDataUrl(url,function(data){

			var i;
			for(i=0;i<data.graphList.length;i++){
				var g = data.graphList[i];
				stage.graphList.push(g);
			}
			for(i=0;i<data.animationList.length;i++){
				var a = data.animationList[i];
				stage.animationList.push(a);
			}
			//this.graphList = data.graphList;
			...
			stage.loadAnimation(name,graph,timeline);
		});
	};
	...
	this.update = function(){
		...
		this.graphList.forEach(function(graph){
			...
			graph.shapes.forEach(function(shape){
